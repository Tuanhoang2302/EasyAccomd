        ...
        <Dialog className={`${report.Report} ${common.common}`} 
            ...
            <div className={report.dialog}>
                ...
                <div className={report.footer}>
                    <div style={{backgroundColor: "#008489", padding:8, borderRadius:8, color:"white", paddingLeft: 16, paddingRight:16, cursor:"pointer", marginRight:10}}
                    onClick={()=>submitOnClick()} disabled={currentChip===null? true:false}>Gửi</div>
                </div>
            </div>
        </Dialog>
    )
