...
export default function(props) {
    ...
    return (
        <div className='AdminTopTab'>
            <div className="option--tab">
                {
                    listTab.map((tab) => <div className="item--tab" onClick={()=>setCurrentTab(tab)}><button className="button--second">{tab}</button></div>)
                }
            </div>
            <div className={"content__title"}>
                <div className="text">{currentTab}</div>
            ...
            <div className="content__table">
                <Table data={data} content={content} currentRow={currentRow} setCurrentRow={setCurrentRow}>
                    <div className="dialog">
                        <Link to="/createAccom/details"><div className="dialog__item">Vô hiệu hóa</div></Link>
