    ...
    render() {
        ...
        return (
            <div className={detailsAccom.ImageAccom}>
                    <br/><br/>
                    <div className={detailsAccom.title}><h2>Làm cho nhà/phòng cho thuê thêm sống động nhờ ảnh chụp</h2></div>
                    <div className={detailsAccom.subTitle}>Chụp ảnh bằng điện thoại hoặc máy ảnh. Tải lên ít nhất một ảnh để 
