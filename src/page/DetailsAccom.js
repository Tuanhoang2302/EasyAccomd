                    ...
                    <div className={`${detailsAccom.DetailsAccom} ${PVT_common.common}`}>
                        {
                            self.state.tab === tabs.MENU? 
                                "":<div className={detailsAccom.DetailAccom__header}>
                                    ...
                                    <Link to="/createAccom"><button className={detailsAccom.right} onClick={self.btnSaveOnClick.bind(self, listAccom, setListAccom, accomSelect)}>Lưu và thoát</button></Link>
                                </div>
                        }
