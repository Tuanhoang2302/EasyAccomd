        ...
        <div className="Manage">
                ...
                <div className="content">
                    ...
                    <div className={(listRowSelect.length>0)? "content__option":"content__option hidden"}>
                        {/* <div className="text">Đã chọn {listRowSelect.length}/{listAccom.length} nhà trọ</div> */}
                        {/* <div className="button"><button className="button--second" onClick={btnCancelOnClick.bind(self)}>Chinh</button></div> */}
